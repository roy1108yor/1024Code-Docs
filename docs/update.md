...
1. IDE 云端资源数据库增加了 Redis 和 Postgres
2. 增加了 Scala、Go 1.20 代码空间模版
3. 优化了文件树拖拽移动文件立即展开文件夹的行为
4. 对部分已知问题进行了处理和优化

## 2023年06月12号

1. 协助掘金社区推出了第6届字节跳动暑假专场青训营，使用1024Code和数千位在校大学生一起成为具有职业竞争力的开发工程师
2. 对代码空间详情页 Embed 的 IDE 进行了优化，增加了全屏放大功能
3. 解决了部分已知问题

## 2023年05月30日

1. 增加了我的邀请码页面和邀请码发放逻辑，社区活跃用户定期会获得邀请码补给，用来邀请同学朋友注册1024Code
2. 对AI编程助手的交互细节进行了优化

## 2023年05月18日

1. 集成到`IDE`内完整的`AI编程助手`上线了，[点击此处](https://docs.1024code.com/Features/AIassistant)，查看功能介绍和使用演示
2. 在`AI助手`回答的过程中增加了停止功能
3. 对`IDE`内数据库模块和`Git`模块的提示内容进行了，根据提示信息，你可以更清晰的了解到如何连接数据库、连接远程仓库、pull/push代码

## 2023年05月06日

1. 上线了新官网首页，就产品特性和使用场景进行了重新说明，若需要的话，你可以分享网站首页（https://1024code.com/）给朋友，更直观的介绍`1024Code`
2. 根据用户反馈对网站和`IDE`部分功能体验进行了优化

## 2023年04月18日

1. 修复了GUI输出窗口默认画布大小下可能会出现的界面内容显示不全的问题（调大了默认画布大小，增加了配置画布大小的能力）
2. 对个人主页部分内容和样式细节进行了优化

## 2023年04月11日

1. 在`IDE`内增加基于`git`功能和远程仓库同步代码的引导提示，可以按照引导在终端 shell 连接远程仓库并推拉代码
2. 合集和代码空间详情页增加对readme.md、README的markdown文件的格式渲染
3. 对部分已知问题进行了修复和优化

## 2023年03月28号

1. 对合集功能进行了优化和升级，可以在IDE环境直接查看合集代码空间，并支持快速切换不同的代码空间；现在你可以尝试打造交互式的编程内容，让其他用户感受交互式编程学习体验。[点击此处查看示例](https://1024code.com/collections/45)
